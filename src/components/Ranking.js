...
const Ranking = () => {
    ...
    function SetCombinations(winCombinations, card, bonus, sbonus) {
        ...
        const monkeys = [<img src={symbols['mono']} width='25'/>, <img src={symbols['mono']} width='25'/>,
            <img src={symbols['mono']} width='25'/>];
        ...
        return (
            <>
                <div>{bonus > 0 ? monkeys : null} {b}{sbonus > 0 ?
                    <>| <img src={symbols['box']}
                             width='23'/></> : null}{sb}{comb}<span>{c.length > 0 ? "+ " : ""}{c}</span></div>
            </>
        );
    }
